...
import { Users, Code2, Sparkles, Loader2 } from "lucide-react";
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
          ...
          <Button
            onClick={handleLogin}
            disabled={isLoading}
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white h-11 text-base font-semibold mb-6 disabled:opacity-50"
          >
