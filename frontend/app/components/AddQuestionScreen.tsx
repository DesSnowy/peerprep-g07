    ...
    <div className="space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {topics.map((t) => (
                    <Button
                      ...
                      className={selectedTopics.includes(t) ? "bg-purple-600 text-white" : "border-2 border-gray-300"}
                    >
                      {t}
                    </Button>
                  ))}
              ...
              {/* Constraints */}
              <div className="space-y-2 md:col-span-2">
                <Label htmlFor="constraints" className="text-gray-700 font-medium">
                  Constraints
                </Label>
                <Textarea
                  id="constraints"
                  ...
                  className="min-h-16 border-2 border-gray-300 resize-none"
                  rows={2}
                />
              </div>
      ...
      <div className="flex justify-end gap-3 pt-4">
        ...
        <Button
          onClick={handleSave}
          disabled={isSaving}
          className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-6 disabled:opacity-50"
        >
