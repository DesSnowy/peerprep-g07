...
export default function App() {
  ...
  // When the user becomes logged in, navigate to matching dashboard
  useEffect(() => {
    if (isLoggedIn && (currentScreen === "login" || currentScreen === "signup" || currentScreen === "forgotPassword")) {
      setCurrentScreen("matching");
    }
  }, [isLoggedIn]);

  // When the user logs out, navigate to login
  useEffect(() => {
  ...
  const handleLogin = () => {
    // Auth context handles the actual login; this just ensures navigation
    setCurrentScreen("matching");
  };
